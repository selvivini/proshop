...
import {Row, Col,Button, Card, ListGroupItem, Image, ListGroup, FormControl} from 'react-bootstrap'
import Message from '../components/Message'
import {addToCart, removeFromCart} from '../actions/cartActions'

//location prop is found inside the router dom which gives the quersystring for qty using location.search
...
dispatch(removeFromCart(id))
    ...
    return (
        <Row>
            <Col md={8}>
                <h1>Shopping Cart</h1>
                {cartItems.length ===0 ? <Message>Your cart items is empty <Link to ="/">Go Back</Link></Message>: 
